# Wiki Index: Data Structures & Algorithms

## 🏗️ Architecture & Meta
- [[wiki-architecture|Wiki Architecture]]
- [[persistent-knowledge|Persistent Knowledge]]
- [[Data-Structure-Summarization-Tracker|Summarization Tracker]]
- [[GEMINI.md|Wiki Schema & Quality Standards]]

## 📚 Core Concepts
- [[python-for-data-structures|Python for Data Structures]]
- [[linked-list|Linked List]]
- [[stack|Stack & Queue]]
- [[tree-and-binary-tree|Tree & Binary Tree]]
...
- [[Lecture-4-Stack|Lecture 4: Stack & Postfix]]
...
- [[Lecture-8-Priority-Queue|Lecture 8: Priority Queue (Heap)]]
- [[Lecture-8.1-Priority-Queue-Ops|Lecture 8.1: Heap Ops]]
...
## 🧠 Synthesis & Analysis
- [[Data-Structure-2567-Series|Course Synthesis (2567)]]
...
- [[the-llm-wiki-idea|LLM Wiki Strategy]]
